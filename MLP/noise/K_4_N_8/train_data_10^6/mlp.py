...
sio.savemat('result/mlp_result', {'ber_trainRatio_trainSNR_testSNR_epoch' : res_ber, 'backward_batch_time_avg' : backward_batch_time_avg, 'forward_time_avg' : forward_time_avg})
