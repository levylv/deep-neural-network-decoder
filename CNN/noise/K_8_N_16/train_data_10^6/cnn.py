...
N = 16
K = 8
data_path = '../../../../RNN/noise/K_8_N_16/train_data_10^6/data/'
num_epoch = 10**5
batch_size = 128
...
sio.savemat('result/cnn_result', {'ber_trainRatio_trainSNR_testSNR_epoch' : res_ber, 'backward_batch_time_avg' : backward_batch_time_avg, 'forward_time_avg' : forward_time_avg})
